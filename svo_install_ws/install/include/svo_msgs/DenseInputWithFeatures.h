...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'sensor_msgs': ['/opt/ros/kinetic/share/sensor_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'svo_msgs': ['/home/zichao/svo_install_ws/src/rpg_svo_pro/svo_msgs/msg']}
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::svo_msgs::DenseInputWithFeatures_<ContainerAllocator> >
  {
...
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::svo_msgs::DenseInputWithFeatures_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
