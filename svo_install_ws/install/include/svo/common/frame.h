...
public:
  ...
  std::vector<std::pair<int, Position>> key_pts_;       //!< Five features and associated 3D points which are used to detect if two frames have overlapping field of view. store index + depth
