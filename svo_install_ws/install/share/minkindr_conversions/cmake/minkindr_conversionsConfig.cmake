...
if("FALSE" STREQUAL "TRUE")
  set(minkindr_conversions_SOURCE_PREFIX /home/zichao/svo_install_ws/src/minkindr_ros/minkindr_conversions)
  set(minkindr_conversions_DEVEL_PREFIX /home/zichao/svo_install_ws/devel)
  ...
  set(minkindr_conversions_INSTALL_PREFIX /home/zichao/svo_install_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'minkindr_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zichao/svo_install_ws/install/${idir}'.  ${_report}")
    endif()
